...
class Args(Tap):
    ...
    kind: Literal["iec", "ieeexplore", "iso", "jedec", "mindshare"]  # Kind of PDF being processed
    ...
    def configure(self):
        ...
        self.add_argument("-k", "--kind")


def unwm_main(in_path: Path, out_path: Path, kind: str) -> None:
    # open
    # per-kind clean
    # generic clean
    # save
...
def main() -> None:
    ...
    unwm_main(args.in_pdf, args.out_pdf, args.kind)
